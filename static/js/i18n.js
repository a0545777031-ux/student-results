...
const I18N = {
  ar:{
    ...
    grade_label:"الصف الدراسي", all_classes:"جميع الصفوف",
    ...
    create_user:"تسجيل مستخدم يدوي", create_btn:"إنشاء الحساب",
    transfer:"نقل الملفات", transfer_title:"نقل ملفات ونتائج مستخدم إلى آخر",
    transfer_to:"إلى المستخدم", transfer_btn:"نقل الملفات",
    moved_ok:"تم نقل الملفات والنتائج بنجاح", create_ok:"تم إنشاء المستخدم بنجاح",
    email_exists_msg:"هذا البريد مستخدم مسبقاً",
    recent_logins:"مرات الدخول", last_30_days:"آخر ٣٠ يوماً",
    no_logins:"لا يوجد تسجيل دخول خلال آخر ٣٠ يوماً",
  ...
  en:{
    ...
    grade_label:"Class", all_classes:"All classes",
    ...
    create_user:"Add user manually", create_btn:"Create account",
    transfer:"Transfer files", transfer_title:"Transfer a user's files & results",
    transfer_to:"To user", transfer_btn:"Transfer files",
    moved_ok:"Files & results transferred", create_ok:"User created",
    email_exists_msg:"This email is already used",
    recent_logins:"Logins", last_30_days:"last 30 days",
    no_logins:"No logins in the last 30 days",
